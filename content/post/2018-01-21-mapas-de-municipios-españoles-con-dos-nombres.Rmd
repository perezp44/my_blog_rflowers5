...
tags: [spatial maps]
description: 'En el post anterior identifique los municipios españoles con dos nombres oficiales, ahora hago mapas espaciales con los paquetes sf, tmap y leaflet. Salen chulos'
...
Primer problema; además, no voy a solucionarlo (recordáis lo de que la perfección no mola!!). Resulta que los datos con los nombres oficiales de municipios son del INE a 1 de diciembre de 2016, pero la shapefile es de 2011 o por ahí (tengo que actualizarla), y claro, desde 2011 ha ocurrido que algunos municipios que se han independizado, juntado etc...

En concreto: 

  - 2 municipios que existían en 2011 (Cesuras y Oza), y por tanto tienen shape, decidieron juntarse y en 2016 ya eran Oza-Cesuras
...
Si te entra curiosidad por saber que municipios son los que se han creado, puedes hacerlo con el chunk de abajo. Hay 4 pueblos de Granada.
...
A ver si puedo hacer un leaflet map
...
Para mi bastante bien. Faltaría poner los lindes provinciales, pero ya vale por hoy.

PERO ... los gráficos se ven en mi ordenador, pero no cuando subo el blog a netlify. El gozo en un pozo!!
