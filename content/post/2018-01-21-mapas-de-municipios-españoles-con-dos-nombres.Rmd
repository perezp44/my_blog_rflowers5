...
Lo mismo que me pasa con las `datatables` me pasa con los `tmaps`. En RStudio sí se muestran, pero no se muestran en el blog; así que hasta que lo solucione, los grabo y los pego.
